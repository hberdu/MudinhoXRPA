...
- **Dragões Dourados**: **só pelo botão** DRAGOES DOURADOS (nunca automático) — vai pro `/tarkan2` e varre a tela atrás dos Golden Tantalos (blocos dourados), manda o personagem em cima e deixa o helper matar; sem nada dourado, anda e procura de novo. Para sozinho em 20min e volta pro farm.
